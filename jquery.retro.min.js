...
var q=(o.height-o["font-size"])/2;if(q<0){q=0;}var l=function(u,B){var y=u+"";y=y.length;var z=a();if(y<2){y=2;}for(var v=y;v>0;--v){var w=Math.floor(u/Math.pow(10,v-1));
var A=a('<div class="digit">').data("cur_digit",w).data("cur_pos",B+v).html('  <div class="back">'+(w>0?w-1:h[B+v])+'</div>					<div class="back-bottom">'+(w)+'</div>					<div class="top-half">					'+(w)+'</div>					<div class="bottom-half">'+(w>0?w-1:h[B+v])+'</div>					<div class="front">'+(w>0?w-1:h[B+v])+'</div>					<div class="shadow">					<div class="top"></div>					<div class="bottom"></div>					</div>');
u=u%Math.pow(10,v-1);z=z.add(A);}return z;};var b=function(u,w,v){u.find(".bottom-half").addClass("ready");u.addClass("flip");setTimeout(function(){u.find(".front").show();
